...
function Home() {
  ...
  return (
    <PageLayout title="About me" avatar="hi">
      ...
      <Box>
        <Typography variant="body2">
          ...
          versatile Front-end developer with a keen interest in creating the user friendly apps and
          websites. I enjoy applying both new technologies and learning about the Best Practice
          solid solutions. I constantly strive to enhance my skills and embrace emerging trends in
          the industry.
        </Typography>
        ...
        <Box sx={rowWrapper}>
          ...
          >
            ...
            user-facing features, optimizing code, building reusable components and using a variety
            of markup languages to create the web pages.
          </ActivityItem>
          ...
          <ActivityItem
            ...
            mr={false}
          >
            As a developer, I find myself most captivated by the power and flexibility of React.js.
            I&#39;m always eager to dive into new projects that leverage React.js, Redux,
            Mui/Bootstrap and other libraries to discover innovative ways to create reliable, fast,
